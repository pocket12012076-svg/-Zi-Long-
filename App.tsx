...
export default function App() {
  ...
  const content = {
    ...
    ja: {
      heroTitle: <>作家・子瓏と共に內面を解剖し<br/>気づきを<span className="italic text-accent">反射神経</span>に変える。</>,
      ...
      aboutText: [
        ...
        "私は「非迎合型」の人間観察者であり、学ぶことが好きで新しいことに挑戦することに意欲的な人間です。私の世界観では、冷静かつ客観的な気づきを追求しています。「人間の行動にはすべて目的がある」という主張を、観察と內省の核心としています。"
      ],
      persona: "ペルソナ",
      readers: "月間読者数",
      cases: "ケーススタディ",
